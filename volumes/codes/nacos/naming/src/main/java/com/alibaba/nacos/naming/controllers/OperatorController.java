...
public class OperatorController {
    ...
    public JSONObject metrics(HttpServletRequest request) {
        ...
        result.put("raftNotifyTaskCount", blockchainCore.getNotifyTaskCount());
    ...
    public Object listStates(@RequestParam(defaultValue = Constants.DEFAULT_NAMESPACE_ID) String namespaceId,
        ...
        List<BlockchainPeer> raftPeerLists = new ArrayList<>();
        ...
        for (BlockchainPeer raftPeer : raftPeerLists) {
    ...
    public JSONObject getClusterStates() {
        ...
        BlockchainPeer peer = serviceManager.getMySelfClusterState();
