...
public class InstanceController {
    ...
    public JSONObject loadBalance() throws Exception {
        naming = NamingFactory.createNamingService("127.0.0.1" + ":" + "8848");
        String jsondata = naming.selectOneHealthyInstance("monitor").toString();
        JSONObject jsonObject = JSON.parseObject(jsondata);
        return jsonObject;
    }

    @GetMapping("/metadata")
    public JSONObject getInstanceMetadata(HttpServletRequest request) throws Exception {
        ...
        return getAnInstancedata(namespaceId, serviceName, agent, clusters, clientIP, udpPort, env, isCheck, app, tenant,
                healthyOnly);
    }
    ...
    public JSONObject getAnInstancedata(String namespaceId, String serviceName, String agent, String clusters, String clientIP,
                                        int udpPort,
                                        String env, boolean isCheck, String app, String tid, boolean healthyOnly)
            throws Exception {
        ...
        if (service == null) {
            ...
            result.put("metadata", new JSONArray());
            return result;
        }
        ...
        if (CollectionUtils.isEmpty(srvedIPs)) {
            ...
            result.put("InstanceMetadata", new JSONArray());
            result.put("name", serviceName);
            result.put("serviceMetadata", service.getMetadata());
            return result;
        }
