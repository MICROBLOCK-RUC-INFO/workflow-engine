...
public class SelectOneHealthyInstance_ITCase {
    ...
    public void selectOneHealthyInstances() throws Exception {
        ...
        naming.registerInstance(serviceName, "127.0.0.1", 8082);
    ...
    public void test1() throws NacosException {
        ...
        String jsondata = naming.selectOneHealthyInstance("provider").toString();
    ...
    public static void main(String[] args) throws Exception {
        SelectOneHealthyInstance_ITCase a = new SelectOneHealthyInstance_ITCase();
        a.test1();
    }
}
