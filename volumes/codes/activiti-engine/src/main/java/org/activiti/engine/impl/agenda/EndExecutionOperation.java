...
public class EndExecutionOperation extends AbstractOperation {
    ...
    protected int getNumberOfActiveChildExecutionsForProcessInstance(ExecutionEntityManager executionEntityManager,
        ...
        //sunzhouxing:自己改的
        //Collection<ExecutionEntity> executions=Context.getCommandContext().getDbSqlSession().findExecutionsByProcessInstanceId(processInstanceId);
    ...
    protected int getNumberOfActiveChildExecutionsForExecution(ExecutionEntityManager executionEntityManager,
                                                               String executionId) {
        //sunzhouxing:自己改的
        //List<ExecutionEntity> executions=Context.getCommandContext().getDbSqlSession().findExecutionsByParentExecutionId(executionId);
