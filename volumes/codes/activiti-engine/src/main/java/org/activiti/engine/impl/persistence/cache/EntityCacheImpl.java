...
public class EntityCacheImpl implements EntityCache {
  //2023-1-27修改，为了保证读写集的有序将HashMap改为LinkedHashMap
  protected Map<Class<?>, Map<String, CachedEntity>> cachedObjects = new LinkedHashMap<Class<?>, Map<String,CachedEntity>>();
  ...
  public CachedEntity put(Entity entity, boolean storeState) {
    ...
    if (classCache == null) {
      classCache = new LinkedHashMap<String, CachedEntity>();
