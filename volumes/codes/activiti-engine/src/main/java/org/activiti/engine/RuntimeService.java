...
public interface RuntimeService {
  ...
  String simulate(operation operation);

  boolean flush(operation operation);

  cachedResponse getWorkflowResponse(String key);
  //真实执行flushCache
  Void flushCache(String[] keys);
  //定时将redis中要删除的entity进行删除
  Void DeleteFormRedis();
