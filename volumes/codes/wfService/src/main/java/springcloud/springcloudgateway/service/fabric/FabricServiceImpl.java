...
// import springcloud.springcloudgateway.config.fabricConfig.MonitorHfClient;
...
//     @Value(value = "${fabric.peertlspath}")
//     private String peerTlsPath;
//     @Value(value = "${fabric.peername}")
//     private String peerName;
//     @Value(value = "${fabric.peeraddr}")
//     private String peerAddr;
//     @Value(value = "${fabric.orderertlspath}")
//     private String ordererTlsPath;
//     @Value(value = "${fabric.orderername}")
//     private String ordererName;
//     @Value(value = "${fabric.ordereraddr}")
...
//     private String userName="admin_cc_deke";
//     private String mspId="DekeMSP";
//     private String crtPath= "/Users/lihaoran/Desktop/project/SCASverify/fabric-nodejs/artifacts/channel/crypto-config/peerOrganizations/fabric.deke.com/users/Admin@fabric.deke.com/msp/signcerts/Admin@fabric.deke.com-cert.pem";
//     private String keyPath= "/Users/lihaoran/Desktop/project/SCASverify/fabric-nodejs/artifacts/channel/crypto-config/peerOrganizations/fabric.deke.com/users/Admin@fabric.deke.com/msp/keystore/09f5b23dded6e6774bfc0f99ba05ac1e0798edecf5732c2466f3331d81f7a4d1_sk";
//     private String peerTlsPath="/Users/lihaoran/Desktop/project/SCASverify/fabric-nodejs/artifacts/channel/crypto-config/peerOrganizations/fabric.deke.com/users/User1@fabric.deke.com/tls/ca.crt";
//     private String peerName="peer1.fabric.deke.com";
//     private String peerAddr= "grpcs://127.0.0.1:8056";
//     private String ordererName= "deke.orderer.com";
//     private String ordererAddr="grpcs://127.0.0.1:8050";
...
//      * 日志文件
//      */
//     Logger logger = LoggerFactory.getLogger(FabricServiceImpl.class);
...
//         //1. 初始化客户端
//         //2. 拼装chaincode请求参数
//         HFClient client = MonitorHfClient.getInstance();
//         TransactionProposalRequest request = client.newTransactionProposalRequest();
//         ChaincodeID ccid = ChaincodeID.newBuilder().setName(chaincodeName).build();
//         request.setChaincodeID(ccid);
//         request.setFcn(func);
//         request.setArgs(args);
//         request.setProposalWaitTime(monitorChannelConfig.getTimeLimit() * 1000);
//         //3. 初始化通道
//         Channel channel = MonitorChannelConfig.getMonitorChannel(client, channelName);
