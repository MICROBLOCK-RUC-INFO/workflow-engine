...
var orgNameTextInputField = require('../provider/camunda/parts/implementation/orgNameTextField');
var fixedTextInputField = require('../provider/camunda/parts/implementation/fixedTextField');
...
EntryFactory.orgNameTextField = function(options){
  return orgNameTextInputField(options, setDefaultParameters(options));
}

EntryFactory.fixedTextField = function(options){
  return fixedTextInputField(options, setDefaultParameters(options));
}
