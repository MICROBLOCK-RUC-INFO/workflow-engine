...
var webServerProps = require('./parts/webServerProps');
var serverProps = require('./parts/serverProps');
// camunda properties
...
function createGeneralTabGroups(
  ...
  //serverProps(serverGroup, element, bpmnFactory, translate);
  ...
  serverProps(detailsGroup, element, bpmnFactory, translate);
...
function createwebServerGroups (element, bpmnFactory, elementRegistry, translate) {
  var webServerGroup = {
    id : 'webServer-properties',
    label: '设置web server',
    entries: []
  };
  webServerProps(webServerGroup, element, bpmnFactory, translate);
...
function CamundaPropertiesProvider(
  ...
  this.getTabs = function(element) {
    ...
    var webServerTab = {
      id: 'webServers',
      label: 'web server setting',
      groups: createwebServerGroups(element, bpmnFactory, elementRegistry, translate)
    }
